package og.hlft.yjn.fabricatech.common.machines;

import net.minecraft.block.Block;
import net.minecraft.item.Item;
import net.minecraft.recipe.RecipeSerializer;
import net.minecraft.recipe.RecipeType;
import og.hlft.yjn.fabricatech.common.machines.core.MachineRecipeSerializer;
import og.hlft.yjn.fabricatech.common.machines.core.MachineRecipeType;
import og.hlft.yjn.fabricatech.datagen.RLangProvider;
import og.hlft.yjn.fabricatech.init.BlockRegistry;
import og.hlft.yjn.fabricatech.init.ItemRegistry;
